...
<head>
    ...
    <title>Sachdeva Steel Products (Ship Breakers) LLP – Sachdeva Group</title>
    <meta name="description"
        content="Sachdeva Steel Products (Ship Breakers) LLP — recycling vessels at Plot 65, Alang Yard since 1994. 36+ ships recycled under HKC, ISO 30000:2009, ISO 9001:2015, ISO 14001:2015 &amp; ISO 45001:2018." />
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ssp-hero::before {
            ...
            background-image:
                ...
                radial-gradient(ellipse at 78% 72%, rgba(46, 125, 79, 0.16), transparent 50%);
            pointer-events: none;
        }
        ...
        /* Slide list items in horizontally with sequential fade */
        .yc-list li {
            opacity: 0;
        ...
        /* Stats cells stagger-in via class */
        .stats-bar.visible .stat-cell {
            opacity: 1;
...
<body>
        ...
        <div class="mh-topbar">
            <div class="mh-topbar-inner">
                <div class="mh-topbar-left">
                    ...
                    <a href="tel:+912782429573"><i class="fas fa-phone"></i> +91 278 2429573</a>
                </div>
                ...
                <nav class="mh-nav">
                    <ul class="mh-nav-list">
                        ...
                        <li class="mh-has-submenu">
                            <a href="javascript:void(0)" class="active" role="button" aria-haspopup="true">Our Companies <i class="fas fa-chevron-down"></i></a>
                            <ul class="mh-submenu" style="min-width: 300px;">
                                <li><a href="sspsb.php" class="active">Sachdeva Steel Products (Ship Breakers)</a></li>
    ...
    <section class="ssp-hero">
        <span class="ssp-badge">Established 1994 · 36+ Ships Recycled</span>
        <h1 id="heroTitle">
            <span class="title-line">Sachdeva Steel Products</span>
            <span class="title-line highlight-gradient">(Ship Breakers) LLP</span>
        </h1>
        <p>A flagship unit of Sachdeva Group, recycling end-of-life vessels at Plot 65, Alang Ship Breaking Yard
            since 1994 — with full HKC compliance and ISO certifications.</p>
        <div class="gold-divider"></div>

        <div class="ssp-hero-meta">
            <span><i class="fas fa-location-dot"></i> Plot 65, Alang</span>
        ...
        <div class="section-inner">
            ...
            <div class="intro-grid">
                <div class="intro-text reveal slide-left">
                    <h3>Sachdeva Steel Products (Ship Breaking Unit)</h3>
                    <p>Sachdeva Steel Products (Ship Breaking Unit) is involved in the business since ship
                        breaking activity started at <strong>Alang in 1983</strong>.</p>
                    <p>In <strong>1994</strong>, we started the business under the name <strong>Sachdeva Steel
                            Products (Ship Breakers)</strong> and till date <strong>36 ships have been
                            Recycled</strong> at our facility — across diverse vessel categories including bulk
                        carriers, tankers, container vessels, and reefers.</p>
                ...
                <div class="yard-card reveal slide-right">
                    ...
                    <ul class="yc-list">
                        <li>
                            ...
                            <div class="yc-meta">
                                <b>Address</b>
                                Plot No 65, Alang Ship Breaking Yard,<br>Alang, Bhavnagar, Gujarat, India
                            </div>
                        </li>
                        <li>
    ...
    <section class="section">
        <div class="section-inner">
            <div class="section-head reveal">
                ...
                <div class="gold-line"></div>
                <p class="section-sub">Every vessel dismantled at Plot 65 Alang from 1994 to date — fully
            ...
            <div class="reveal">
                <div class="ships-controls">
                    ...
                    <div class="ships-count">
                        Showing <strong id="shipCount">36</strong> of <strong>36</strong> vessels
                    </div>
                </div>
                ...
                <div class="ships-table-wrap">
                    <div class="ships-table-scroll">
                        <table class="ships-table" id="shipsTable">
                            ...
                            <tbody>
                                <tr><td><span class="sr-num">01</span></td><td class="col-name">M.V KIRVOSK</td><td><span class="type-pill">Fishery Trawler</span></td><td class="col-ldt">2,374.000</td><td><span class="year-pill">1994-1995</span></td></tr>
                                <tr><td><span class="sr-num">02</span></td><td class="col-name">M.V NEFTHORSK</td><td><span class="type-pill">Fishery Trawler</span></td><td class="col-ldt">2,205.700</td><td><span class="year-pill">1994-1995</span></td></tr>
                                <tr><td><span class="sr-num">03</span></td><td class="col-name">M.V ZELENOGRAD</td><td><span class="type-pill">Fish Factory Trawler</span></td><td class="col-ldt">2,352.000</td><td><span class="year-pill">1994-1995</span></td></tr>
                                <tr><td><span class="sr-num">04</span></td><td class="col-name">M.V UNITED GLORY</td><td><span class="type-pill">General Cargo</span></td><td class="col-ldt">5,818.000</td><td><span class="year-pill">1995-1996</span></td></tr>
                                <tr><td><span class="sr-num">05</span></td><td class="col-name">M.V NOVOKLALSPLIT</td><td><span class="type-pill">Motor Tanker</span></td><td class="col-ldt">7,605.300</td><td><span class="year-pill">1995-1996</span></td></tr>
                                <tr><td><span class="sr-num">06</span></td><td class="col-name">M.V OCEANWAY</td><td><span class="type-pill">Bulk Carrier</span></td><td class="col-ldt">11,900.000</td><td><span class="year-pill">1996-1997</span></td></tr>
                                <tr><td><span class="sr-num">07</span></td><td class="col-name">M.V METHANE PRINCESS</td><td><span class="type-pill">LPG Carrier</span></td><td class="col-ldt">10,311.000</td><td><span class="year-pill">1996-1997</span></td></tr>
                                <tr><td><span class="sr-num">08</span></td><td class="col-name">M.V KAROLINA</td><td><span class="type-pill">General Cargo</span></td><td class="col-ldt">5,563.000</td><td><span class="year-pill">1997-1998</span></td></tr>
                                <tr><td><span class="sr-num">09</span></td><td class="col-name">M.V GUI YANG</td><td><span class="type-pill">Motor Tanker</span></td><td class="col-ldt">5,986.000</td><td><span class="year-pill">1997-1998</span></td></tr>
                                <tr><td><span class="sr-num">10</span></td><td class="col-name">M.V VIN CHUAN</td><td><span class="type-pill">General Cargo</span></td><td class="col-ldt">5,989.000</td><td><span class="year-pill">1998-1999</span></td></tr>
                                <tr><td><span class="sr-num">11</span></td><td class="col-name">M.V KITSA</td><td><span class="type-pill">Bulk Carrier</span></td><td class="col-ldt">9,307.000</td><td><span class="year-pill">1999-2000</span></td></tr>
                                <tr><td><span class="sr-num">12</span></td><td class="col-name">M.T CAPTAIN X. KYRIAKOU</td><td><span class="type-pill">Product Tanker</span></td><td class="col-ldt">9,092.900</td><td><span class="year-pill">2000-2001</span></td></tr>
                                <tr><td><span class="sr-num">13</span></td><td class="col-name">M.T GEM GEMINI</td><td><span class="type-pill">Motor Tanker</span></td><td class="col-ldt">7,716.000</td><td><span class="year-pill">2001-2002</span></td></tr>
                                <tr><td><span class="sr-num">14</span></td><td class="col-name">M.V BALTIMORE</td><td><span class="type-pill">Product Tanker</span></td><td class="col-ldt">8,268.000</td><td><span class="year-pill">2002-2003</span></td></tr>
                                <tr><td><span class="sr-num">15</span></td><td class="col-name">M.V MIGHTY</td><td><span class="type-pill">Bulk Carrier</span></td><td class="col-ldt">8,005.500</td><td><span class="year-pill">2003-2004</span></td></tr>
                                <tr><td><span class="sr-num">16</span></td><td class="col-name">M.T ASEAN POWER</td><td><span class="type-pill">Motor Tanker</span></td><td class="col-ldt">3,586.730</td><td><span class="year-pill">2003-2004</span></td></tr>
                                <tr><td><span class="sr-num">17</span></td><td class="col-name">M.V CONTINENTAL GLORY</td><td><span class="type-pill">Motor Vessel</span></td><td class="col-ldt">6,675.000</td><td><span class="year-pill">2003-2004</span></td></tr>
                                <tr><td><span class="sr-num">18</span></td><td class="col-name">M.V VITYA</td><td><span class="type-pill">Research Vessel</span></td><td class="col-ldt">4,550.000</td><td><span class="year-pill">2004-2005</span></td></tr>
                                <tr><td><span class="sr-num">19</span></td><td class="col-name">M.V S.S EWA</td><td><span class="type-pill">Container Vessel</span></td><td class="col-ldt">14,898.000</td><td><span class="year-pill">2006-2007</span></td></tr>
                                <tr><td><span class="sr-num">20</span></td><td class="col-name">M.V EAST CARRIER</td><td><span class="type-pill">General Cargo</span></td><td class="col-ldt">1,991.000</td><td><span class="year-pill">2007-2008</span></td></tr>
                                <tr><td><span class="sr-num">21</span></td><td class="col-name">M.V NORDIC ICE</td><td><span class="type-pill">Reefer</span></td><td class="col-ldt">4,675.000</td><td><span class="year-pill">2008-2009</span></td></tr>
                                <tr><td><span class="sr-num">22</span></td><td class="col-name">M.V RHEIN</td><td><span class="type-pill">General Cargo</span></td><td class="col-ldt">12,295.000</td><td><span class="year-pill">2009-2010</span></td></tr>
                                <tr><td><span class="sr-num">23</span></td><td class="col-name">D.V REM</td><td><span class="type-pill">General Cargo</span></td><td class="col-ldt">5,550.000</td><td><span class="year-pill">2009-2010</span></td></tr>
                                <tr><td><span class="sr-num">24</span></td><td class="col-name">M.V AN SAN</td><td><span class="type-pill">General Cargo</span></td><td class="col-ldt">3,064.000</td><td><span class="year-pill">2010-2011</span></td></tr>
                                <tr><td><span class="sr-num">25</span></td><td class="col-name">M.V STAR IV</td><td><span class="type-pill">Juice Carrier</span></td><td class="col-ldt">6,117.000</td><td><span class="year-pill">2010-2011</span></td></tr>
                                <tr><td><span class="sr-num">26</span></td><td class="col-name">M.V ALCEM CALACA</td><td><span class="type-pill">Cement Carrier</span></td><td class="col-ldt">5,119.300</td><td><span class="year-pill">2011-2012</span></td></tr>
                                <tr><td><span class="sr-num">27</span></td><td class="col-name">M.V SUPREME HARVEST</td><td><span class="type-pill">Reefer</span></td><td class="col-ldt">4,740.000</td><td><span class="year-pill">2012-2013</span></td></tr>
                                <tr><td><span class="sr-num">28</span></td><td class="col-name">CHUETSU MARU</td><td><span class="type-pill">Woodchip Carrier</span></td><td class="col-ldt">9,216.000</td><td><span class="year-pill">2012-2013</span></td></tr>
                                <tr><td><span class="sr-num">29</span></td><td class="col-name">M.V SIOUX MAIDEN</td><td><span class="type-pill">Bulk Carrier</span></td><td class="col-ldt">6,506.000</td><td><span class="year-pill">2015-2016</span></td></tr>
                                <tr><td><span class="sr-num">30</span></td><td class="col-name">MV QUIETY LADY</td><td><span class="type-pill">Bulk Carrier</span></td><td class="col-ldt">5,723.000</td><td><span class="year-pill">2015-2016</span></td></tr>
                                <tr><td><span class="sr-num">31</span></td><td class="col-name">MV TURQUOISE</td><td><span class="type-pill">Container Vessel</span></td><td class="col-ldt">21,672.000</td><td><span class="year-pill">2016-2017</span></td></tr>
                                <tr><td><span class="sr-num">32</span></td><td class="col-name">MV ARU</td><td><span class="type-pill">Bulk Carrier</span></td><td class="col-ldt">9,821.000</td><td><span class="year-pill">2017-2018</span></td></tr>
                                <tr><td><span class="sr-num">33</span></td><td class="col-name">MV LOMBO</td><td><span class="type-pill">Container Vessel</span></td><td class="col-ldt">3,206.500</td><td><span class="year-pill">2017-2018</span></td></tr>
                                <tr><td><span class="sr-num">34</span></td><td class="col-name">MV MYKONOS</td><td><span class="type-pill">Container Vessel</span></td><td class="col-ldt">23,451.000</td><td><span class="year-pill">2017-2018</span></td></tr>
                                <tr><td><span class="sr-num">35</span></td><td class="col-name">MV KWEICHOW</td><td><span class="type-pill">General Cargo</span></td><td class="col-ldt">9,432.000</td><td><span class="year-pill">2019-2020</span></td></tr>
                                <tr><td><span class="sr-num">36</span></td><td class="col-name">MV PROGRESS</td><td><span class="type-pill">Refined Sugar Packing Carrier</span></td><td class="col-ldt">11,788.580</td><td><span class="year-pill">2019-2020</span></td></tr>
                            </tbody>
                        </table>
                    </div>
        ...
        <div class="section-inner">
            ...
            <div class="insights-grid stagger">
                <div class="insight-card reveal flip-x" style="--i:0">
                    ...
                    <h3>Yard Layout</h3>
                    <p>Plot 65 at Alang spans dedicated zones for vessel beaching, cutting, hazardous-material
                    ...
                    <svg class="yard-svg" viewBox="0 0 400 200" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <!-- sea -->
                        <rect x="0" y="120" width="400" height="80" fill="url(#sea)"/>
                ...
                <div class="insight-card reveal flip-x" style="--i:1">
                    ...
                    <p>Every vessel processed at our yard is recycled in full alignment with the
                        <strong style="color: var(--gold-light);">Hong Kong International Convention</strong> for
                        the Safe and Environmentally Sound Recycling of Ships — covering inventory of hazardous
                        materials, ship recycling plan, and safe-for-entry certification.</p>
    ...
    <script>
        ...
        (function () {
            ...
            if (!h) return;
            // Replace text nodes with word-spans, preserve nested elements
            ...
            // Index spans across the whole heading for proper cascade
                ...
                const io = new IntersectionObserver((entries) => {
                    entries.forEach((e) => {
                        if (e.isIntersecting) {
                            ...
                            // Force reflow before adding cascade class so transitions trigger
